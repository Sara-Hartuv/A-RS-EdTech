...
export default function TeacherDashboardPage() {
  ...
  return (
    <div className="mt-6 space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-l from-primary-600 to-primary-700 rounded-xl p-6 text-white shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            ...
            <span className="text-primary-100">תלמידות</span>
          </div>
        </div>
      </div>
      ...
      {students.length === 0 ? (
        <div className="bg-white rounded-xl shadow p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-neutral-700 mb-2">אין תלמידות משויכות</h3>
          <p className="text-neutral-500">פנו למנהלת המערכת כדי לשייך תלמידות לחשבון שלכם</p>
        </div>
      ) : (
        <div className="bg-white rounded-xl shadow overflow-hidden">
          <div className="border-b border-neutral-100 p-4">
            <h2 className="font-semibold text-neutral-800">התלמידות שלי</h2>
          </div>
