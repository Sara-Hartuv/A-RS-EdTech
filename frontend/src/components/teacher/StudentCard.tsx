      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-neutral-400">{student.phone}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {hasCurrentWeekPoints ? (
            <div className="flex items-center gap-2">
              <span className="text-sm text-neutral-600">נקודות השבוע:</span>
        ...
        <div className="flex items-center gap-2">
          {unredeemedVouchersCount > 0 ? (
            <button
              ...
              className="flex items-center gap-2 bg-primary-100 hover:bg-primary-200 text-primary-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors group"
            >
            ...
            <button
              onClick={onToggleVoucher}
              className="flex items-center gap-2 bg-neutral-100 hover:bg-primary-100 text-neutral-600 hover:text-primary-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
